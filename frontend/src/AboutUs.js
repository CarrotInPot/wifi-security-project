    ...
    return (
        <div className="about-container">
            ...
            <div className="about-content">
                <p>
                    Welcome to our Wi-Fi Security Project! The goal of this project is to help users understand and improve their Wi-Fi security by offering recommendations based on the current Wi-Fi settings. Our research and analysis conducted throughout the year ensures we stay up-to-date with the latest security trends.
                </p>
                <p>
                    Our system allows you to input information about your Wi-Fi configuration, such as authentication methods, cipher types, and usage scenarios (home, business, public, etc.). Based on this information, we provide tailored security recommendations to ensure that your network is as secure as possible.
                </p>
                <p>
