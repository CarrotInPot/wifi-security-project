    ...
    return (
        <div className="terms-container">
            ...
            <p>
                ...
                SecureWi-Fi's Website.
            </p>
            
            <h2>1. Acceptance of Terms</h2>
            <p>
                By accessing this website, we assume you accept these terms and conditions. Do not continue to use
                SecureWi-Fi if you do not agree to all of the terms and conditions stated on this page.
            </p>
            ...
            <p>
                You may not use this website in a way that is unlawful or harmful to SecureWi-Fi. Prohibited activities include,
                but are not limited to, spreading malware, hacking, or attempting to gain unauthorized access to our systems.
            </p>
            
            <h2>4.Limitation of Liability</h2>
            <p>
                SecureWi-Fi will not be liable for any damages arising out of or in connection with your use of the website,
            ...
            <p>
                The content, images, logos, and other materials on this website are the property of SecureWi-Fi or its licensors.
